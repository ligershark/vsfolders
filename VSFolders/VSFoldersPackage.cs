// --------------------------------------------------------------------------------------------------------------------
// <copyright file="VSFoldersPackage.cs" company="Microsoft">
...
namespace Microsoft.VSFolders
{
    ...
    public sealed class VSFoldersPackage : Package
    {
        ...
        private static readonly Lazy<DTE2> DTEValue =
            new Lazy<DTE2>(() => ServiceProvider.GlobalProvider.GetService(typeof (DTE)) as DTE2);

        private static readonly ConcurrentDictionary<Type, DialogPage> DialogPageInstanceLookup =
            new ConcurrentDictionary<Type, DialogPage>();
        ...
        {
            get { return VSFoldersPackage.DTEValue.Value; }
        }
        ...
        private void ShowToolFoldersWindow(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.FindToolWindow(typeof (FoldersWindow), 0, true);
